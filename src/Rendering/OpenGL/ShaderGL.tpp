...
template<> inline void ShaderGL::SetUniform<2>(const std::string &name, std::size_t count, unsigned char transpose, const float *value) const
{ Use(); GL_CALL(glUniformMatrix2fv(GetLocation(name), count, transpose, value)); }
template<> inline void ShaderGL::SetUniform<3>(const std::string &name, std::size_t count, unsigned char transpose, const float *value) const
{ Use(); GL_CALL(glUniformMatrix3fv(GetLocation(name), count, transpose, value)); }
template<> inline void ShaderGL::SetUniform<4>(const std::string &name, std::size_t count, unsigned char transpose, const float *value) const
